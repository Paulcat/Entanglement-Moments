...
%KLEP_STEP2 Step 2.1 and 2.2 in [Klep et al.]
%   Derivative of 2x2 minors. corresponding nullspace, random vector in
...
v       = K_inter(:,randi(size(K_inter,2),1)); % random vector in kernel
