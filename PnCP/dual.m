function [a,b,c,d]=dual(N, x0, y0, z0, map)
...
F=[trace(J2x*rho)==x0, trace(J2y*rho)==y0, trace(J2z*rho)==z0, trace(rho)==1, rho>=0, trace(Jx*rho)==0, trace(Jz*rho)==0, ApplyPnCP_left(4, 2, rho, map)>=0, ApplyPnCP_right(2, 4, rho, map)>=0];
...
Fd=[trace(rhod)==1, rhod>=0, trace(Jx*rhod)==0, trace(Jz*rhod)==0, ApplyPnCP_left(4, 2, rhod, map)>=0, ApplyPnCP_right(2, 4, rhod, map)>=0];
